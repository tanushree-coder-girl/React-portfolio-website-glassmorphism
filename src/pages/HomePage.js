    ...
    return (
        <section className="home">
            ...
            <div className="typography">
                <h1>Hello I'm <span>Maria Doe</span></h1>
                {/*===== Typing Text====== */}
                <h2>i am a <span><Typewriter
                    words={['Front End Developer', 'website designer', 'Photographer', 'Graphics designer']}
                    loop={false}
                    cursor
                    cursorStyle='_'
                    typeSpeed={70}
                ...
                /></span></h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam corporis nisi, tenetur modi ducimus hic?</p>

                {/*========= Social media icons======= */}
                <div className="share">
                    <a href="https://www.facebook.com/" target="__blank"> <FacebookIcon /> </a>
                    <a href="https://twitter.com/" target="__blank"> <TwitterIcon /> </a>
